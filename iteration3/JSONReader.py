    ...
    def readLabSections(self):
        try:
            ...
            for labSection in labSectionsArray:
                ...
                course = self.__department.courseCodeCourseMap.get(courseCode)
                ...
                self.__department.sectionCodeCourseMap[labSectionCode] = course
                self.__department.labSectionCourseMap[newLabSection] = course
    ...
    def readTranscript(self, student):
        try:
            ...
            for course in courses:
                ...
                courseCode = course.get("courseCode")
                course1 = self.__department.courseCodeCourseMap.get(courseCode)
    ...
    def readAdvisors(self):
        try:
            ...
            for advisor in advisorsArray:
                ...
                self.__department.advisors.append(newAdvisor)
